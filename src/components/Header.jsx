    ...
    <>
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
          isScrolled
            ? "bg-github-canvas-subtle/95 dark:bg-github-canvas-subtle/95 backdrop-blur-sm border-b border-github-border-default shadow-sm"
            : "bg-github-canvas-default dark:bg-github-canvas-default border-b border-github-border-muted"
        }`}
      >
