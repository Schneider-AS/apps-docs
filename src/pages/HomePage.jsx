  ...
  return (
    <>
      <SEO
        ...
        description="Portal de documentação legal dos aplicativos da Aguiar Sistemas - Termos de Uso e Política de Privacidade para AS BI e AS Carrinho"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 relative z-10">
            <div className="text-center">
              ...
              <p className="text-xl text-github-fg-muted max-w-3xl mx-auto mb-10 leading-relaxed">
                ...
                só lugar. Mantenha-se informado sobre termos de uso, políticas
                de privacidade e diretrizes.
              </p>
